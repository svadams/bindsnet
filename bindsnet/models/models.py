...
class DiehlAndCook2015sp(Network):
    # language=rst
    """
    Implements the spiking neural network architecture from `(Diehl & Cook 2015)
    <https://www.frontiersin.org/articles/10.3389/fncom.2015.00099/full>`_.
    With addition of connections that allow for structural plasticity
    """
    ...
    def __init__(
        ...
        :param tc_theta_decay: Time constant of ``DiehlAndCookNodes`` threshold
            potential decay.
        :param inpt_shape: The dimensionality of the input layer.
        :param prune_prob: Probability of pruning a connection
        :param prune_thresh: Threshold for pruning a connection
        :param create_prob: Probability of creating a new connection 

        :param create Enable activity dependent creation of new connections
        """
        super().__init__(dt=dt)
        ...
        input_exc_conn = DynamicConnection(
            source=input_layer,
            target=exc_layer,
            w=w,
            update_rule=PostPre,
